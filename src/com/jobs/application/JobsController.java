...
public class JobsController {
	...
	public void createManagerEmployee(String name, String address, String phone, double salaryPerMonth) throws Exception{
		Employee manager = new Employee(name, address, phone,  salaryPerMonth, com.jobs.application.PaymentFactory.createPaymentRateEmployee());
	...
	public void payAllEmployeers() {
		List<com.jobs.domain.AbsStaffMember> miembros= new ArrayList<>();
		miembros = repository.getAllMembers();
		for (com.jobs.domain.AbsStaffMember e : miembros){
	...
	public void createVolunteer(String name, String address, String phone) throws Exception{
		com.jobs.domain.Volunteer voluntario = new Volunteer(name, address, phone, "voluntario sin sueldo");
