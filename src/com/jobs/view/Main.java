...
public class Main {
	...
	private static com.jobs.persistence.EmployeeRepository lista_empleados = new EmployeeRepository();
	private static JobsController controller=new JobsController( lista_empleados );
